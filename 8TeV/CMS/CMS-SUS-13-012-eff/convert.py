...
def add ( dataset ):
    ...
    T5WW_x05.addSource('efficiencyMap',"orig/T5WW_EM/T5WW_x05/MA5_EM_T5WW_x05_%s.dat" % dataset_n, "txt")
    #+++++++ next mass plane block ++++++++++++++
    T5WW_x005 = T5WW.addMassPlane([[x,0.05*x + 0.95*y,y]]*2)
    #T5WW_x005.dataUrl = None
    T5WW_x005.addSource('efficiencyMap',"orig/T5WW_EM/T5WW_x005/MA5_EM_T5WW_Glu005Neu095_%s.dat" % dataset_n, "txt")
    #+++++++ next mass plane block ++++++++++++++
    T5WW_x095 = T5WW.addMassPlane([[x,0.95*x + 0.05*y,y]]*2)
    #T5WW_x095.dataUrl = None
    T5WW_x095.addSource('efficiencyMap',"orig/T5WW_EM/T5WW_x095/MA5_EM_T5WW_Glu095Neu005_%s.dat" % dataset_n, "txt")
    T5WW_d077 = T5WW.addMassPlane([[x,y+77,y]]*2)
    #T5WW_d077.dataUrl = None
    T5WW_d077.addSource('efficiencyMap',"orig/T5WW_EM/cms_sus_13_012_T5WW_77_EM_MAPS/MA5_EM_T5WW_77_%s.dat" % dataset_n, "txt")
    T5WW_d010 = T5WW.addMassPlane([[x,y+10,y]]*2)
    #T5WW_d010.dataUrl = None
    T5WW_d010.addSource('efficiencyMap',"orig/T5WW_EM/cms_sus_13_012_T5WW_10_EM_MAPS/MA5_EM_T5WW_10_%s.dat" % dataset_n, "txt")
    ...
    TChiZZ_1.addSource ( "efficiencyMap", "orig/TChi_EM/cms_sus_13_012_TChiZZ_1_EM_MAPS/MA5_EM_TChiZZ_1_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    TChiWZ_1.addSource ( "efficiencyMap", "orig/TChi_EM/cms_sus_13_012_TChiWZ_1_EM_MAPS/MA5_EM_TChiWZ_1_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    T5bbbb_x005.addSource ( "efficiencyMap", "orig/T5bbbb_EM/cms_sus_13_012_T5bbbb_x005_EM_MAPS/MA5_EM_T5bbbb_x005_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    T5tttt_x05.addSource ( "efficiencyMap", "orig/T5tttt_EM/cms_sus_13_012_T5tttt_x05_EM_MAPS/MA5_EM_T5tttt_x05_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    T6bbWW_x05.addSource ( "efficiencyMap", "orig/T6bbWW_EM/cms_sus_13_012_T6bbWW_x05_EM_MAPS/MA5_EM_T6bbWW_x05_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    T6bbWW_x01 = T6bbWW.addMassPlane( [[x,0.1 *x + 0.9 *y,y]]*2  )
    T6bbWW_x01.addSource ( "efficiencyMap", "orig/T6bbWW_EM/cms_sus_13_012_T6bbWW_x01_EM_MAPS/MA5_EM_T6bbWW_x01_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    T6bbWW_x09 = T6bbWW.addMassPlane( [[x,0.9 *x + 0.1 *y,y]]*2  )
    T6bbWW_x09.addSource ( "efficiencyMap", "orig/T6bbWW_EM/cms_sus_13_012_T6bbWW_x09_EM_MAPS/MA5_EM_T6bbWW_x09_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    T6bbWW_d10 = T6bbWW.addMassPlane( [[x, y+10 , y ]]*2  )
    T6bbWW_d10.addSource ( "efficiencyMap", "orig/T6bbWW_EM/cms_sus_13_012_T6bbWW_DiffChargNeu10_EM_MAPS/MA5_EM_T6bbWW_DiffChargNeu10_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    T6bbWW_d77 = T6bbWW.addMassPlane( [[x, y+77 , y ]]*2  )
    T6bbWW_d77.addSource ( "efficiencyMap", "orig/T6bbWW_EM/cms_sus_13_012_T6bbWW_DiffChargNeu77_EM_MAPS/MA5_EM_T6bbWW_DiffChargNeu77_%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    TGQ.source = 'SModelS'
    TGQ.dataUrl = None
    for num in  [name.split('_')[1] for name in os.listdir('orig/T3GQon_EM') if 'TGQ' in name]: # listing the gluino masses from the name in the directories
    #for num in  ['200','300']:
    ...
    T5_DeltaSqNeu_5.addSource ( "efficiencyMap", "orig/T5_EM/cms_sus_13_012_T5_DeltaSqNeu_5/MA5_EM_T5_MAPS_SR%s.dat" % dataset_n, "txt", objectName ="None", index = None )
    ...
    T5ZZ_x05.addSource('efficiencyMap',"orig/T5ZZ_EM/T5ZZ_x05/MA5_EM_T5ZZ_x05_%s.dat" % dataset_n, "txt")
    #+++++++ next mass plane block ++++++++++++++
    T5ZZ_x005 = T5ZZ.addMassPlane([[x,0.05*x + 0.95*y,y]]*2)
    T5ZZ_x005.addSource('efficiencyMap',"orig/T5ZZ_EM/T5ZZ_x005/MA5_EM_T5ZZ_Glu005Neu095_%s.dat" % dataset_n, "txt")
    #+++++++ next mass plane block ++++++++++++++
...
# *************************************************************
    ...
    #+++++++ next mass plane block ++++++++++++++
    T6WWttoff_DeltaStopNeu130 = T6WWttoff.addMassPlane([[x, y+130 , y]]*2)
...
#    T6ttZZoff.source = 'SModelS'
    ...
    #+++++++ next mass plane block ++++++++++++++
    T6ttZZ_DeltaStopNeu200 = T6ttZZ.addMassPlane([[x, x-200 , y]]*2)
