...
#files = [47,49,51,53,55]
SR	  = ['SRAT0','SRATT','SRATW','SRBT0','SRBTT','SRBTW','SRC1','SRC2','SRC3','SRC4','SRC5','SRDhigh','SRDlow','SRE','SREGtc']

for i in range(len(SR)):
    ACC = 'Acc'+str(SR[i])+'.csv'
    EFF = 'Eff'+str(SR[i])+'.csv'
    Map_Multiplier('T2tt',SR[i],ACC,EFF,2,2,10000) #norm=10000
