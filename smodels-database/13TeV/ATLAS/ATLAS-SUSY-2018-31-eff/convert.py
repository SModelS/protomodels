...
info.publication     = ''
info.datasetOrder    = '"SRA_L", "SRA_M", "SRA_H", "SRB", "SRC_22", "SRC_24", "SRC_26", "SRC_28"'
info.jsonFiles       = {"BkgOnlyA.json": ["SRA_L", "SRA_M", "SRA_H"],
                        "BkgOnlyB.json": ["SRB"],
                        "BkgOnlyC.json": ["SRC_22", "SRC_24", "SRC_26", "SRC_28"]}
