...
def Reading_Values(input,num_col,column):
    ...
    for line in inputFile:
        if line[0] != '#' and line[0] != '*' and line[0] != '\n' and line[0] != '$' and line[0] != 'M' and line[0] != '"':
            #            print line
...
TP 	  = ['T5Gamma', 'T5Gamma', 'T6Gamma', 'T6Gamma', 'TChipChimGamma', 'TChipChimGamma', 'T5Gamma', 'T5Gamma']
SR	  = ['SRyy-SL','SRyy-SH', 'SRyy-SL', 'SRyy-SH', 'SRyy-WL', 'SRyy-WH', 'SRyj-L', 'SRyj-H']

for i in range(8):
    ACC = 'Acceptance'+str(i+1)+'.csv'
    EFF = 'Efficiency'+str(i+1)+'.csv'
    Map_Multiplier(TP[i],SR[i],ACC,EFF,2,2,1) #norm=10000
