"""
.. module:: model_spec
   :synopsis: Defines the BSM particles to be used for the protomodels, within
   SModelS. Properties not defined here and defined by the LHE or SLHA input file (such as masses, width and BRs) are automatically added later.
...
Zprime = Particle(isSM=False, label="Z'", pdg=55, eCharge=0, colordim=1, spin=1, _isInvisible=False)
